...
if __name__ == "__main__":
    ...
    if saved_image_path:
        ...
        if image_file_path != None: save_image_path(image_file_path)
        else:
    ...
    if image_file_path: image = pygame.image.load(image_file_path)
    ...
    image = pygame.transform.scale(image, (config.image_width, config.image_height))
    image_rect = image.get_rect()
